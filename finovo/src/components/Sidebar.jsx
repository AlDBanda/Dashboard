...
import { FaBuilding, FaChevronRight, FaRegSun, FaTachometerAlt, FaWallet } from 'react-icons/fa';
      ...
      <div className='pt-[15px] border-b-[1px] border-[#EDEDED]/[0.3]'>
        ...
        <div className='flex items-center justify-between gap-[10px] py-[15px] cursor-pointer' onClick={handleBudgetSubMenuToggle}>
          <div className='flex items-center gap-[10px]'>
            ...
            <p className='text-[14px] leading-[20px] font-normal text-white'>Budget Management</p>
          </div>
        ...
        {showBudgetSubMenu && (
          <div className='pl-[20px]'>
            <ul className='list-disc p1-4 text-white'>
              <li className='hover:text-blue-300'>Budget Planner</li>
              <li className='hover:text-blue-300'>Expense Form</li>
              <li className='hover:text-blue-300'>Expense Items</li>
              <li className='hover:text-blue-300'>Expense List</li>
            </ul>
          </div>
        )}
        ...
        <div className='flex items-center justify-between gap-[10px] py-[15px] cursor-pointer' onClick={handleFinancialSubMenuToggle}>
          <div className='flex items-center gap-[10px]'>
            ...
            <p className='text-[14px] leading-[20px] font-normal text-white'>Financial Tools</p>
          </div>
        ...
        {showFinancialSubMenu && (
          <div className='pl-[20px]'>
           <ul className='list-disc p1-4 text-white'>
              <li className='hover:text-blue-300'>Loan Calculator</li>
              <li className='hover:text-blue-300'>Savings Goal Tracker</li>
            </ul>
          </div>
        )}
        ...
        <div className='flex items-center justify-between gap-[10px] py-[15px] cursor-pointer' onClick={handleBranchSubMenuToggle}>
          <div className='flex items-center gap-[10px]'>
            ...
            <p className='text-[14px] leading-[20px] font-normal text-white'>Branch & Services</p>
          </div>
        ...
        {showBranchSubMenu && (
          <div className='pl-[20px]'>
         <ul className='list-disc p1-4 text-white'>
              <li className='hover:text-blue-300'>Branch Locator</li>
              <li className='hover:text-blue-300'>Financial Education</li>
            </ul>
          </div>
        )}
      </div>
